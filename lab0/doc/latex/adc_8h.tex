...
\begin{DoxyCompactList}\small\item\em This class will run the A/\-D converter on an A\-V\-R processor. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
emstream \& \hyperlink{adc_8h_a6e6d1e227b216fe2a1fee9b0ea52180d}{operator$<$$<$} (emstream \&, \hyperlink{classadc}{adc} \&)
\begin{DoxyCompactList}\small\item\em This overloaded operator prints A/\-D values. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This overloaded operator prints A/\-D values. 

Prints outs the value fo the A\-D\-M\-U\-X and A\-D\-C\-S\-R\-A register values at time of conversion Also prints the current value being read by the A/\-D. 
